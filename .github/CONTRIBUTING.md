...
1. **Initial setup** (only do this once)
    ...
    At this point the local clone of your fork only knows that it came from *your* repo, github.com/USERNAME/simgen-ssg.git, but doesn't know anything the *main* repo, [https://github.com/sharmashobhit/simgen-ssg.git](https://github.com/sharmashobhit/simgen-ssg). You can see this by running
