...
from simgen_ssg import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "simgen-ssg"
copyright = f"{datetime.today().year}, Shobhit S."
author = "Shobhit S."
...
html_title = f"simgen-ssg v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/sharmashobhit/simgen-ssg",
            "html": """
